...
const initialState = {
  decks: [
    ...
    {id:2, topicName: 'Basics', image: 'http://images.twinkl.co.uk/image/private/t_630/image_repo/17/92/T2-G-357-Basic-Chinese-Phrases-PowerPoint.jpg'},
    ...
    {id:5, topicName: 'Weather', image: 'http://goldentroutwilderness.files.wordpress.com/2012/01/various-weather.jpg'},
